...
#for each planet data we have to do the extra scapping
for index, data in enumerate(planet_data):
    scrape_more_data(data[5]) #creates a new list of data - new_planet_data
    print(f"{index+1} page done")

#to create the final merged list 
final_planet_data = []
for index, data in enumerate(planet_data):
